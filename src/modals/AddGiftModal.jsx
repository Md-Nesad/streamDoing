...
export default function AddGiftModal({ open, onClose }) {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/30 z-50">
      <div className="w-[650px] bg-white rounded-2xl shadow-lg p-6">
        {/* Title */}
        ...
        <div className="mt-10 flex justify-end gap-4">
          <button
            onClick={onClose}
            className="border px-6 py-1 rounded-md text-gray-700"
          >
            Cancel
          </button>

          <button className="px-8 py-1 rounded-md text-white bg-linear-to-r from-purple-400 to-pink-500 shadow">
            Confirm
          </button>
        </div>
      </div>
