...
export default function HostDetailsModal({ open, onClose, agency }) {
  if (!open) return null;
  console.log(agency);
      ...
      <div className="bg-[#FDFDFD] w-full max-w-md rounded-xl shadow-lg sm:p-6 p-4 relative animatefadeIn">
        ...
        <div className="space-y-3 text-sm sm:text-lg">
          ...
          <div className="flex justify-between">
            ...
            <p className="text-gray-800">{agency?.location || "N/A"}</p>
          </div>
          ...
          <div className="flex justify-between">
            ...
            <p className="text-gray-800">Lv{agency?.level}</p>
          </div>
          ...
          <div className="flex justify-between">
            ...
            <p
              className={`${agency?.isVerify ? "text-green-600" : "text-red-600"}`}
            >
              {agency?.isVerify ? "Verified" : "Not Verified"}
            </p>
          </div>
          ...
          <div className="flex justify-between">
            ...
            <p className="text-gray-800">{agency.vipStatus ? "Yes" : "No"}</p>
          </div>
