...
import CoinPortalHeader from "../components/coinAgencyPortal/common/CoinPortalHeader";
import CoinPortalSidebar from "../components/coinAgencyPortal/common/CoinPortalSidebar";

export default function CoinPortalLayout() {
  return (
    <>
